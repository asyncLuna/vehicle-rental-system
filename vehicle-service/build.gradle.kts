...
}; repositories { mavenCentral() }; dependencyManagement { imports { mavenBom("org.springframework.cloud:spring-cloud-dependencies:2025.0.0") } }
dependencies {
...
); implementation("org.springframework.cloud:spring-cloud-starter-netflix-eureka-client"); implementation("org.springframework.boot:spring-boot-starter-amqp"); runtimeOnly(
    "org.postgresql:postgresql"
); testImplementation("org.springframework.boot:spring-boot-starter-test"); testImplementation("org.testcontainers:junit-jupiter:1.21.3"); testImplementation(
